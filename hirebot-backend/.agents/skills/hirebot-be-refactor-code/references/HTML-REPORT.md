...
The diagrams carry the weight. Prose is sparse, plain, and uses the glossary terms (from the module-design vocabulary (`hirebot-be-coding-standards/references/module-design.md`)) without ceremony.
...
Pick the simplest pattern that shows the candidate's problem. Snippets for each are in `hirebot-be-workflow/references/VISUAL-REPORT.md`.
...
- Follow the "Standard look" in `hirebot-be-workflow/references/VISUAL-REPORT.md`: white page, colour only for the legend states and recommendation strength.
...
Plain English, concise, but the architectural nouns and verbs come straight from the module-design vocabulary (`hirebot-be-coding-standards/references/module-design.md`). Concision is not an excuse to drift.
