...
> Markdown for offline use in the HireBot rules pack; section numbers kept or added
> for cross-referencing. Content otherwise unchanged. HireBot deviations are
