...
Copyright Google LLC. Licensed under CC-BY 3.0 (https://creativecommons.org/licenses/by/3.0/).
Copied for offline use (one relative link made absolute) in the OneSpace rules pack. OneSpace deviations are
listed in ../python-style.md; that file wins where they differ.
-->
...
To help you format code correctly, we've created a [settings file for Vim](https://github.com/google/styleguide/blob/gh-pages/google_python_style.vim). For Emacs, the default settings should be fine.
