...
- [2 Source file basics](#source-file-basics)
  - [2.1 File name](#file-name)
  - [2.2 File encoding: UTF-8](#file-encoding)
  - [2.3 Special characters](#special-characters)
    - [2.3.1 Whitespace characters](#whitespace-characters)
...
- [5 Language features](#language-features)
  ...
  - [5.11 Disallowed features](#disallowed-features)
...
to TypeScript, and following the [TypeScript guide](tsguide.md).
