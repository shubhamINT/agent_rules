...
> Copyright Google LLC. Licensed under CC-BY 3.0
> (https://creativecommons.org/licenses/by/3.0/). Converted from HTML to
> Markdown for offline use in the OneSpace rules pack; section numbers kept or added
> for cross-referencing. Content otherwise unchanged. OneSpace deviations are
> listed in `../typescript-style.md` — that file wins where they differ.

## Table of Contents

- [1 Introduction](#introduction)
  - [1.1 Terminology notes](#terminology-notes)
...
- [8 Comments and documentation](#comments-documentation)
    - [8.0.1 JSDoc versus comments](#jsdoc-vs-comments)
    - [8.0.2 Multi-line comments](#multi-line-comments)
  - [8.1 JSDoc general form](#jsdoc-general-form)
  - [8.2 Markdown](#jsdoc-markdown)
  - [8.3 JSDoc tags](#jsdoc-tags)
  - [8.4 Line wrapping](#jsdoc-line-wrapping)
  - [8.5 Document all top-level exports of modules](#document-all-top-level-exports-of-modules)
  - [8.6 Class comments](#jsdoc-class-comments)
  - [8.7 Method and function comments](#method-and-function-comments)
  - [8.8 Parameter property comments](#parameter-property-comments)
  - [8.9 JSDoc type annotations](#jsdoc-type-annotations)
  - [8.10 Make comments that actually add information](#redundant-comments)
    - [8.10.1 Comments when calling a function](#comments-when-calling-a-function)
  - [8.11 Place documentation prior to decorators](#place-documentation-prior-to-decorators)
- [9 Policies](#policies)
