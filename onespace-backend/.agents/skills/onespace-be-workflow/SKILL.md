...
script, or folder still updates the README (`onespace-be-structure-service/references/readme-standard.md`). Unsure =
...
2. **`AGENTS.md` without the markers** `<!-- onespace-be:start -->` /
   `<!-- onespace-be:end -->` — append the template's marked block (markers
...
- **README gaps** — compare the README with `onespace-be-structure-service/references/readme-standard.md` and with
...
- update the README per `onespace-be-structure-service/references/readme-standard.md` — requirements, installation,
