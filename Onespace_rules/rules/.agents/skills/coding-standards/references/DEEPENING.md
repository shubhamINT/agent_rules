...
How to deepen a cluster of shallow modules safely, given its dependencies. Assumes the vocabulary in [module-design.md](module-design.md): **module**, **interface**, **seam**, **adapter**.
